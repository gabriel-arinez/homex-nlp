...
INSERT INTO proformas(id,numero,cliente_id,vendedor_id,estado_id,moneda_id) VALUES(90003,90003,90001,1,pg_temp.cv('ESTADO_PROFORMA','APROBADA'),pg_temp.cv('MONEDA','BOB')); DO $$ BEGIN ASSERT NOT EXISTS(SELECT 1 FROM pedidos WHERE proforma_id=90003); RAISE NOTICE 'VERIFICADO'; END $$;
SELECT 'AUDIT_OK';
ROLLBACK;
