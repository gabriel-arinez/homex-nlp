...
INSERT INTO capturas(id,proforma_id,vendedor_id) VALUES(90001,90001,1),(90002,90002,1); INSERT INTO items_ia(id,captura_id,nombre) VALUES(90001,90001,'Prueba'); INSERT INTO items_humano(captura_id,item_ia_id,nombre) VALUES(90002,90001,'Prueba'); DO $$ BEGIN RAISE NOTICE 'VERIFICADO'; END $$;
SELECT 'AUDIT_OK';
ROLLBACK;
