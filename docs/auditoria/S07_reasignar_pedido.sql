...
UPDATE proformas SET estado_id=pg_temp.cv('ESTADO_PROFORMA','APROBADA') WHERE id=90001;UPDATE pedidos SET proforma_id=90002 WHERE proforma_id=90001; DO $$ BEGIN ASSERT EXISTS(SELECT 1 FROM pedidos WHERE proforma_id=90002); RAISE NOTICE 'VERIFICADO'; END $$;
SELECT 'AUDIT_OK';
ROLLBACK;
