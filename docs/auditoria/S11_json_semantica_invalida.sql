...
INSERT INTO capturas(id,proforma_id,vendedor_id) VALUES(90001,90001,1); INSERT INTO items_ia(captura_id,nombre,dimensiones,espesor,accesorios) VALUES(90001,'','{"ancho": -10, "unidad": "banana"}','{}','[42]'); DO $$ BEGIN RAISE NOTICE 'VERIFICADO'; END $$;
SELECT 'AUDIT_OK';
ROLLBACK;
